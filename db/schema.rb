ActiveRecord::Schema.define do
  ...
  add_index "asset_host_core_api_users", ["auth_token", "is_active"], :name => "index_asset_host_core_api_users_on_auth_token_and_is_active"
  ...
  add_index "asset_host_core_asset_outputs", ["output_id"], :name => "index_asset_host_core_asset_outputs_on_output_id"
  ...
  add_index "asset_host_core_outputs", ["code"], :name => "index_asset_host_core_outputs_on_code"
  ...
  add_index "asset_host_core_permissions", ["resource", "ability"], :name => "index_asset_host_core_permissions_on_resource_and_ability"
