...
#       it { should be_allowed_to :read, "Asset" }
#     end

#     context "when the user does not have the permission" do
#       it { should_not be_allowed_to :read, "Asset" }
#     end
#   end
# end
