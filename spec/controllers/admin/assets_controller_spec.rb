...
describe Admin::AssetsController, type: :controller do
  ...
  describe 'GET show' do
    it 'gets the previous and next assets' do
      ...
      get :show, params: admin_request_params(id: assets[1].id)
  ...
  describe 'GET destroy' do
    it 'destroys the asset' do
      asset = create :asset
      delete :destroy, params: admin_request_params(id: asset.id)
      Asset.count.should eq 0
    end
  end
  ...
  describe "GET metadata" do
    it 'gets all the assets in the ID param' do
      assets = create_list :asset, 2
      get :metadata, params: admin_request_params(ids: assets.map(&:id).join(","))
      assigns(:assets).should eq assets
    end
  end
  ...
  describe 'PUT update_metadata' do
    it 'finds the passed-in assets and updates them' do
      ...
      put :update_metadata, params: admin_request_params(
        :assets => {
