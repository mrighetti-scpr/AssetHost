...
class Output
  ...
  def calculate_size width, height
    ...
    s_width  = (s_properties.find{|p| p["name"] == "width" } || {})["value"].to_f
    s_height = (s_properties.find{|p| p["name"] == "height"} || {})["value"].to_f
    ...
    c_width  = (c_properties.find{|p| p["name"] == "width"}  || {})["value"].to_f
    c_height = (c_properties.find{|p| p["name"] == "height"} || {})["value"].to_f
    result["width"]  = [s_width,  c_width,  width].compact.min
    result["height"] = [s_height, c_height, height].compact.min
    result
