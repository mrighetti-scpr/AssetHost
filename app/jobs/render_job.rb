class RenderJob < ApplicationJob
  ...
  def perform asset_output_id
    ...
    asset_output.image_data = uploader.put file: file, id: asset.id, convert_options: asset_output.convert_options, style_name: asset_output.output.code, content_type: asset.try(:image_content_type)
    asset_output.save
  end
end
