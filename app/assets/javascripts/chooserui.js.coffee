class AssetHost.ChooserUI
    ...
    constructor: (options = {}) ->
        ...
        if @browser
            ...
            @browser.assets.bind "admin", (asset) =>
                window.open("/assets/#{asset.get('id')}")
    ...
    class @URLInput extends Backbone.View
        template: JST["templates/url_input"]
    ...
    class @EditModal extends Backbone.View
        template: JST["templates/edit_modal"]
        ...
        _admin: ->
            window.open("/assets/#{@model.get('id')}")
    ...
    class @AfterUploadButton extends Backbone.View
        template: JST['templates/after_upload_button']
        events:
            'click a': '_clicked'
    ...
    class @UploadAllButton extends Backbone.View
        template: JST['templates/upload_all_button']
        events:
